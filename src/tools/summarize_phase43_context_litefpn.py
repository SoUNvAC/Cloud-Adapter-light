...
def main():
    ...
    if phase31.get("phase") != 31 or phase31.get("passed") is not True:
        raise SystemExit("Phase 43 requires the frozen V8 benchmark from Phase 31")
    root = Path(args.root)
    ...
    result = {
        ...
        "seed": 42,
        "architecture": {"context_source": "stride32_global_average",
                         "context_projection": "320_to_128_1x1",
                         "gate": "2_times_sigmoid", "zero_initialized": True,
                         "gated_levels": 4},
