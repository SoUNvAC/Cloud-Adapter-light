...
def main():
    ...
    if phase31.get("phase") != 31 or phase31.get("passed") is not True:
        raise SystemExit("Phase 41 requires the frozen V8 benchmark from Phase 31")
    root = Path(args.root)
    ...
    result = {
        ...
        "seed": 42,
        "architecture": {"detail_channels": 16, "detail_gate_init": 0.1,
                         "detail_kernel": 3, "injection": "stride4_mask_only"},
